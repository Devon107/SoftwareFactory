...
public class ControlLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        negocioTUsuario.getUsuario().setContrasenia(request.getParameter("txtContrasenia").getBytes());
        
        negocioTUsuario.Login();
        
        try 
        {
            if (!(negocioTUsuario.getUsuario().getIdUsuario().equals("")))
            {   
                HttpSession actual= request.getSession(true);
                actual.setAttribute("Logueado",request.getParameter("txtUsuario"));
