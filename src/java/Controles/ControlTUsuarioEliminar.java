 ...
 */
@WebServlet(name = "ControlTUsuarioEliminar", urlPatterns = {"/ControlTUsuarioEliminar"})
public class ControlTUsuarioEliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getMethod().equals("GET"))
        {
            ...
            negocioTUsuario.Eliminar();
            
            negocioTUsuario.GetAll();
        
            request.setAttribute("negocioTUsuario", negocioTUsuario);

            request.getRequestDispatcher("UsuarioMostrar.jsp").forward(request, response);
        }
