 ...
 * @author Montano
 */
@WebServlet(name = "ServletSistemaMenuInsert", urlPatterns = {"/ServletSistemaMenuInsert"})
public class ServletSistemaMenuInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getMethod().equals("GET"))
        {
            if (request.getParameter("id") == null)
            {
                ...
                tipoRequerimiento.setIdTipoRequerimiento("ME001");
                ...
                negociorequerimiento.GetType();

                request.setAttribute("negocioRequerimiento", negociorequerimiento);  
                request.getRequestDispatcher("SistemaMenuInsert.jsp").forward(request, response);
            }
            else
            {
