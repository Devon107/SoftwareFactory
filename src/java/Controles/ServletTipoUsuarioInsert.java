 ...
 */
@WebServlet(name = "ServletTipoUsuarioInsert", urlPatterns = {"/ServletTipoUsuarioInsert"})
public class ServletTipoUsuarioInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getMethod().equals("GET")){
            request.getRequestDispatcher("TipoUsuarioInsert.jsp").forward(request, response);
        }
        if(request.getMethod().equals("POST")){
            ...
            boolean retorno = negociotipousuario.insert();
